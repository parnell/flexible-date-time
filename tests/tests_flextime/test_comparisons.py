...
from flexible_datetime.flextime_class import flextime


def test_eq():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt2 = flextime("2024-06-28T14:30:00")
    assert fdt1 == fdt2


def test_ne():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt2 = flextime("2023-06-28T14:30:00")
    assert fdt1 != fdt2
...
def test_lt():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt2 = flextime("2024-06-29T14:30:00")
    assert fdt1 < fdt2
...
def test_le():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt2 = flextime("2024-06-28T14:30:00")
    fdt3 = flextime("2024-06-29T14:30:00")
    assert fdt1 <= fdt2
    assert fdt1 <= fdt3


def test_gt():
    fdt1 = flextime("2024-06-29T14:30:00")
    fdt2 = flextime("2024-06-28T14:30:00")
    assert fdt1 > fdt2
...
def test_ge():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt2 = flextime("2024-06-28T14:30:00")
    fdt3 = flextime("2024-06-27T14:30:00")
    assert fdt1 >= fdt2
    assert fdt1 >= fdt3
...
def test_lt_with_mask():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt1.apply_mask(year=True)
    fdt2 = flextime("2023-06-29T14:30:00")
    fdt2.apply_mask(year=True)
...
def test_gt_with_mask():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt1.apply_mask(year=True)
    fdt2 = flextime("2025-06-27T14:30:00")
    fdt2.apply_mask(year=True)
    assert fdt1 > fdt2  # Masked year should be ignored
...
def test_ge_with_mask():
    fdt1 = flextime("2024-06-28T14:30:00")
    fdt1.apply_mask(year=True)
    fdt2 = flextime("2023-06-27T14:30:00")
    fdt2.apply_mask(year=True)
    assert fdt1 >= fdt2  # Masked year should be ignored


def test_eq_yyyy_mm_dd():
    fdt1 = flextime("2024-06-28")
    fdt2 = flextime("2024-06-28")
    assert fdt1 == fdt2


def test_ne_yyyy_mm_dd():
    fdt1 = flextime("2024-06-28")
    fdt2 = flextime("2023-06-28")
    assert fdt1 != fdt2
...
def test_le_yyyy_mm_dd():
    fdt1 = flextime("2024-06-28")
    fdt2 = flextime("2024-06-28")
    fdt3 = flextime("2024-06-29")
    assert fdt1 <= fdt2
    assert fdt1 <= fdt3


def test_gt_yyyy_mm_dd():
    fdt1 = flextime("2024-06-29")
    fdt2 = flextime("2024-06-28")
    assert fdt1 > fdt2
...
def test_ge_with_mask_yyyy_mm_dd():
    fdt1 = flextime("2024-06-28")
    fdt1.apply_mask(year=True)
    fdt2 = flextime("2023-06-27")
    fdt2.apply_mask(year=True)
    assert fdt1 >= fdt2  # Masked year should be ignored


def test_eq_yyyy_mm():
    fdt1 = flextime("2024-06")
    fdt2 = flextime("2024-06")
    assert fdt1 == fdt2


def test_ne_yyyy_mm():
    fdt1 = flextime("2024-06")
    fdt2 = flextime("2023-06")
    assert fdt1 != fdt2
...
def test_le_yyyy_mm():
    fdt1 = flextime("2024-06")
    fdt2 = flextime("2024-06")
    fdt3 = flextime("2024-07")
    assert fdt1 <= fdt2
    assert fdt1 <= fdt3


def test_gt_yyyy_mm():
    fdt1 = flextime("2024-07")
    fdt2 = flextime("2024-06")
    assert fdt1 > fdt2
